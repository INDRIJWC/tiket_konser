                ...
                <div class="card shadow bg-white z-index-2">
                    ...
                    <div class="card-body p-3">
                        <div class="card-body px-0 pb-2">
                            <form method="post" action="{{ url('/check/ticket') }}" class="pt-3">
                                @csrf
                                <label>Nomor Tiket</label>
                                <div class="mb-3">
                                    <input type="number" name="idt" class="form-control" placeholder="Nomor Tiket" aria-label="Ticket" aria-describedby="Ticket-addon">
                                </div>
                                <div class="text-center">
                                    <button type="submit" class="btn bg-gradient-success w-100 mt-4 mb-0">Checkin</button>
                                </div>
                            </form>
                        </div>
                    </div>
